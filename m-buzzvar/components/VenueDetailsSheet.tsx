  ...
  const renderReviewList = () => (
    <View style={{ flex: 1 }}>
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <Text style={styles.fullReviewsTitle}>All Reviews</Text>
        }
      />
    </View>
  );
      ...
      <View style={styles.content}>
        ...
        <View style={styles.ratingRow}>
          ...
          <Text style={styles.ratingText}>
            ...
            {(venue.review_count || 0) === 1 ? "review" : "reviews"})
          </Text>
        </View>
            ...
            {venue.review_count > 2 && (
              ...
              >
                <Text style={styles.seeAllText}>
                  View all {venue.review_count} reviews
                </Text>
                <Ionicons
        ...
        <TouchableOpacity
          ...
          onPress={handlePresentAddReview}
        >
